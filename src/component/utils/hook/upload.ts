  ...
  switch (action.type) {
    case "add-file":
      return {
        ...
        fileList: [
          ...state.fileList,
          ...(action.payload as UploadPayload["add-file"]).files,
        ],
        fileNameList: [
          ...state.fileNameList,
          ...(action.payload as UploadPayload["add-file"]).names,
        ],
      };
      break;
    case "delete-file":
      return {
        ...
        fileList: state.fileList.filter(
          (el) => el.id !== (action.payload as UploadPayload["delete-file"])
        ),
        fileNameList: state.fileNameList.filter(
          (el) => el.id !== (action.payload as UploadPayload["delete-file"])
        ),
      };
      break;
    ...
    case "start-upload":
      return {
        ...state,
        start: action.payload as UploadPayload["start-upload"],
      };
      break;
    case "uploading":
      return {
        ...state,
        progress: action.payload as UploadPayload["uploading"],
      };
      break;
    case "toast-id":
